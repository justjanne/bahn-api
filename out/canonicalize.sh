...
cleanup_xml "${CURRENT_DIR}/iris_station" 2
cleanup_xml "${CURRENT_DIR}/iris_realtime" 4
cleanup_xml "${CURRENT_DIR}/iris_timetable" 4
cleanup_xml "${CURRENT_DIR}/iris_wingdef" 2
cleanup_json "${CURRENT_DIR}/apps_wagenreihung" 226
